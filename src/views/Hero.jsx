            ...
            <main className='min-h-screen px-8 md:px-10 flex items-center text-center md:text-left relative'>
                <div className='max-w-[1500px] mx-auto w-full h-full relative z-10'>
                    <motion.div className='w-fit flex flex-col gap-y-5' variants={containerVariants} initial="hidden" animate="visible">
                        ...
                        <a href="https://t.me/Openlogic88">
  <motion.button initial={{ opacity: 0, x: -250 }} animate={{ opacity: 0.7, x: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className='border-[1px] border-accent bg-accent/20 rounded-[5px] py-3 px-5 w-full md:w-fit hover:bg-accent/40 transition-all ease-out duration-300'>
    Contact Now
  </motion.button>
</a>
                    </motion.div>
